...
screen TextDisplay1(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
    ...
    frame:
        ...
        ypos yAlign
        xpos xAlign
        text Text slow_cps 40 color "#fff" 
        background None

screen TextDisplay2(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
...
screen TextDisplay3(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
...
screen TextDisplay4(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
...
screen TextBox(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
...
screen TextBox1(Text, yAlign, xAlign):
    on "show" action Function(HistoryAdd, Text)
...
init python:
    def HistoryAdd(what):
        narrator.add_history(kind="adv", who=None, what=what)
        return
...
screen say(who, what):
    ...
    window:
        ...
        if who is not None:
            ...
            window:
                id "namebox"
                if renpy.variant("touch") and renpy.variant("web"):
                    style "namebox"
                    xanchor 0.0
                    xpos 130
                    ypos 5
...
screen navigation():
    ...
    if renpy.get_screen("main_menu"):
        frame:
            style "copyright"
            text "{font=Play-Regular.ttf}© {/font}2025 Liam Latz" color "#fff" 
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("Automatic saves"), quick=_("Saves"))
